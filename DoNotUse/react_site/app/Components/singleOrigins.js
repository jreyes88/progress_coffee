	...
	render: function(){
		return(
			<div className="container">
		        <h5 className="center" id="singleOrigin">
		        ...
		        <div className="row">
		                ...
		                <div className="row">
		                    <div className="card">
		                        <div className="card-image">
		                            <img src="images/single_origin/01-brazil.png" className="materialboxed"/>
		                        </div>
		            ...
		            <div className="col s12 m4">
		                <div className="row">
		                    <div className="card">
		                        <div className="card-image">
		                            <img src="images/single_origin/02-ethiopia.png"/>
		                        </div>
		                        <div className="card-content">
		                            <span className="card-title activator grey-text text-darken-4">
		                                Ethiopia
		            ...
		            <div className="col s12 m4">
		                <div className="row">
		                    <div className="card">
		                        <div className="card-image">
		                            <img src="images/single_origin/03-guatemala.png"/>
		                        </div>
		                        <div className="card-content">
		                            <span className="card-title activator grey-text text-darken-4">
		                                Guatemala
		        ...
		        <div className="row">
		            <div className="col s12 m4">
		                <div className="row">
		                    <div className="card">
		                        <div className="card-image">
		                            <img src="images/single_origin/04-honduras.png"/>
		                        </div>
		                        <div className="card-content">
		                            <span className="card-title activator grey-text text-darken-4">
		                                Honduras
		            ...
		            <div className="col s12 m4">
		                <div className="row">
		                    <div className="card">
		                        <div className="card-image">
		                            <img src="images/single_origin/05-png.png"/>
		                        </div>
		                        <div className="card-content">
		                            <span className="card-title activator grey-text text-darken-4">
		                                Papua New Guinea
		            ...
		            <div className="col s12 m4">
		                <div className="row">
		                    <div className="card">
		                        <div className="card-image">
		                            <img src="images/single_origin/06-decaf.png"/>
		                        </div>
		                        <div className="card-content">
		                            <span className="card-title activator grey-text text-darken-4">
		                                Decaf
		        ...
		        <div className="row">
		            <div className="col s12 m4 offset-m2">
		                <div className="row">
		                    <div className="card">
		                        <div className="card-image">
		                            <img src="images/single_origin/07-sumatra.png"/>
		                        </div>
		                        <div className="card-content">
		                            <span className="card-title activator grey-text text-darken-4">
		                                Sumatra
		            ...
		            <div className="col s12 m4">
		                <div className="row">
		                    <div className="card">
		                        <div className="card-image">
		                            <img src="images/single_origin/08-tanzania.png"/>
		                        </div>
		                        <div className="card-content">
		                            <span className="card-title activator grey-text text-darken-4">
		                                Tanzania
